...
List<BookDicItem> bookList = [
  ...
  BookDicItem(name: "毛泽东选集", path: "assets/book/毛泽东选集全七卷(官方、静火、润之赤旗三合一版) (毛泽东) (Z-Library).epub", type: BookType.ming),
  ...
  BookDicItem(name: "渊海子平", path: "assets/book/渊海子平.epub", type: BookType.ming),
